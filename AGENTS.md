...
- Latest compact-row verification: typecheck and 146 tests passed. Twelve local responsive/menu/search checks passed (320, 393, 768, 1024, 1214, 1280, 1366, 1440, 1600, 1920, 2560, and 1100×500), including all eight desktop links aligned on one row, no clipping/overlap, height at most 68px, no desktop More, bounds, search/filter/navigation, Ctrl+K, scroll compaction, Escape and focus restoration. Live computed geometry confirmed 64px height and all eight visible labels at the same y coordinate at 1214px, with no runtime/module errors. The compact-row screenshot was blocked by iframe_hidden, so its visual appearance is not automatically verified. Mobile/tablet CSS was confirmed byte-for-byte unchanged. The preceding version had live About/lamp, Client Login, search and mobile More/Home interaction passes; earlier local tests additionally covered route back/reload and both motion preferences.
