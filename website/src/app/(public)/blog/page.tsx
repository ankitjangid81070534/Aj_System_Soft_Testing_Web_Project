        ...
        {categories.length > 0 ? (
          <nav aria-label="Article categories" className="flex flex-wrap gap-2">
            <Link
              ...
              className={cn(
                "inline-flex min-h-11 items-center rounded-full border px-3.5 py-1.5 text-sm font-medium transition-colors focus-ring",
                !categorySlug
            ...
            <div className="flex gap-2">
              {page > 1 ? (
                <Link
                  ...
                  className="inline-flex min-h-11 items-center rounded-full border border-line bg-surface px-3 py-1.5 font-medium text-ink hover:bg-canvas focus-ring"
                >
                  Previous
                </Link>
              ) : null}
