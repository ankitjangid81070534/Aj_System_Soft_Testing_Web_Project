...
export default async function PublicLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex min-h-svh flex-col">
      ...
      <a
        href="#main-content"
        className="sr-only z-70 focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-70 focus:rounded-full focus:bg-surface focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:text-ink focus:shadow-e3"
      >
        Skip to content
      </a>
      <MarketingHeader
      ...
      <Footer settings={settings} managedLinks={navigation.footer} />
