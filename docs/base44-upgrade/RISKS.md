# Retained risks and blockers — 30-phase Phase 0

These are current source/availability findings, not repaired in Phase 0. Older potential bugs with later source fixes must not be reported as still unfixed merely from old reports.
...
| R07 | Medium: stale setup guidance | Admin setup notice says migrations 0001–0012 while 0016 exists; older docs claim broad idempotence | Confirm actual applied versions and data effects before any SQL; don't run legacy privileged test seeds. |
